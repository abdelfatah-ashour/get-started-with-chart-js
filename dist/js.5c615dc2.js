...
var monthlyWrapper = document.getElementById("monthlyCTX");
var activesWrapper = document.getElementById("activesCTX");
var revenueWrapper = document.getElementById("revenue");
var monthlyData = {
  labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
  datasets: [{
    label: "monthly sales",
    data: [5, 14, 4, 8, 9, 6, 8],
    backgroundColor: ["#84e8f4", "#4f46ba", "#84e8f4", "#4f46ba", "#84e8f4", "#4f46ba"],
    borderWidth: 1,
    borderRadius: 4
  }]
};
...
var monthlyCTX = new Chart(monthlyWrapper, {
  type: "bar",
  data: monthlyData,
  options: monthlyOptions
});
var activesCTX = new Chart(activesWrapper, {
  type: "line",
  data: activeData,
  options: activeOptions
});
var revenueCTX = new Chart(revenueWrapper, {
  type: "line",
  data: revenueData,
